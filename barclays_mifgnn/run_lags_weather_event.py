...
class Regression(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_reg):
        ...
        self.weather_linner = nn.Linear(7, hidden_dim)
        ...
        self.weather_hidden128 = nn.Linear(7, hidden_dim)
    ...
    def forward(self, lags, weather, event):
        ...
        weather = torch.reshape(weather, (-1, 7))
...
def run_model(hidden_dim=128, lags_decay=0.12, weather_decay=0.12, event_decay= 0.001, b_decay=0, merge_decay=0.082, other_decay=0.07):
    # Create model
