...
#         print(epoch,val_mse)
        if val_mse < min_val_mse:
            min_val_mse = val_mse
            torch.save(model, 'pred_train_terminal5_lags_weather_event.pkl')

    return 'pred_train_terminal5_lags_weather_event.pkl'
...
#         print(epoch, val_mse)
        if val_mse < min_val_mse:
            min_val_mse = val_mse
            torch.save(model, 'terminal5_lags_weather_event.pkl')

    model = torch.load('terminal5_lags_weather_event.pkl')
    model.eval()
